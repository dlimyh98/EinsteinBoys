...
function Authentication( {setisAuth} ) {
    ...
    const register = () => {
        Axios({
            ...
            url: "https://einsteinboys.herokuapp.com/server/register",                 // POST TO this route (location of Backend login route)
        }).then((res) => {
    ...
    const login = () => {
        Axios({
            ...
            withCredentials: true,
            url: "https://einsteinboys.herokuapp.com/server/login",
        }).then((res) => {
    ...
    const getUser = () => {
        Axios({
            method: "GET",
            withCredentials: true,
            url: "https://einsteinboys.herokuapp.com/server/user",
